				...
				{cuisines.map((cuisine) => {
					return (
						<Link
							...
							className='flex flex-row justify-center items-center p-4 m-4 bg-black/70 rounded-md cursor-pointer border-2 border-black hover:border-primary hover:scale-105'
						>
